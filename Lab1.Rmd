...
*Repsonse: Ten unique cities are within the new table of baked_pumpkins.*
...
*Response: The most correlated variable is the package one, as the other two have a negative correlation.*
...
*Response: Having the package data as a character data could be a complicated way to fit linear regression.*
